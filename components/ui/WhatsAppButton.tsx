...
export default function WhatsAppButton() {
  ...
  const message = encodeURIComponent(
    locale === "ar"
      ? "مرحباً، أود الاستفسار عن خدمات الطاقة الشمسية لديكم."
      : "Bonjour, je souhaite obtenir des informations sur vos solutions d'énergie solaire."
  );
  ...
  return (
    <a
      ...
      className={`
        fixed bottom-6 z-50 rounded-full w-14 h-14
        bg-[#25D366] flex items-center justify-center
        opacity-0 scale-50 transition-transform active:scale-95
        shadow-lg hover:shadow-[#25D366]/40
        group animate-whatsapp pulse-ring
