      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className={`cta-content text-center ${isRTL ? "font-cairo" : ""}`}>
          ...
          <div className={`flex flex-col sm:flex-row gap-4 justify-center ${isRTL ? "sm:flex-row-reverse" : ""}`}>
            <Link
              href="/contact"
              className="bg-[#1D1D1B] hover:bg-[#2d2c29] text-white font-extrabold px-8 py-4 rounded-full text-lg transition-all duration-200 hover:scale-105 shadow-lg"
            >
              {t("button")}
            </Link>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#1da851] text-white font-extrabold px-8 py-4 rounded-full text-lg transition-all duration-200 hover:scale-105 shadow-lg"
            >
